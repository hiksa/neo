...
{    
    ...
    public abstract class UIntBase : IEquatable<UIntBase>, ISerializable
    {
        ...
        /// </summary>
        public int Size => this.dataBytes.Length;
        ...
        /// </summary>
        public static bool operator !=(UIntBase left, UIntBase right) => !(left == right);

        /// <summary>
        /// Method Serialize writes the data_bytes array into a BinaryWriter object
        /// </summary>
        void ISerializable.Serialize(BinaryWriter writer) => writer.Write(this.dataBytes);

        /// <summary>
        /// Method ToArray() returns the byte array data_bytes, which stores the little-endian unsigned int
        /// </summary>
        public byte[] ToArray() => this.dataBytes;

        /// <summary>
        /// Deserialize function reads the expected size in bytes from the given BinaryReader and stores in data_bytes array.
        /// </summary>
        void ISerializable.Deserialize(BinaryReader reader) => reader.Read(this.dataBytes, 0, this.dataBytes.Length);
        ...
        public bool Equals(UIntBase other)
        {
            ...
            if (this.dataBytes.Length != other.dataBytes.Length)
            {
                return false;
            }

            return this.dataBytes.SequenceEqual(other.dataBytes);
        }
        ...
        /// </summary>
        public override string ToString() => "0x" + this.dataBytes.Reverse().ToHexString();
        ...
        /// </summary>
        public override int GetHashCode() => this.dataBytes.ToInt32(0);
    }
}
